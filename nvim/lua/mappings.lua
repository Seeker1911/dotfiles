...
map("n", "<leader>fh", "<cmd>Telescope help_tags<CR>", { desc = "Telescope: Search help page" })
...
map("n", "<leader>cm", "<cmd>Telescope git_commits<CR>", { desc = "Telescope: Browse git commits" })
map("n", "<leader>gt", "<cmd>Telescope git_status<CR>", { desc = "Telescope: Show git status" })
