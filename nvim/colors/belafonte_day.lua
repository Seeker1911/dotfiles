-- Belafonte Day -- a warm, paper-cream light colorscheme.
-- Derived from the Belafonte Day kitty palette.
...
local c = {
    ...
    -- diff tints (lighter washes of the accent colors)
    diff_add    = "#c8d4a8",
    diff_change = "#e9d8a4",
    diff_delete = "#e6b6b1",
    diff_text   = "#d8c486",
...
vim.g.terminal_color_13 = c.rust
