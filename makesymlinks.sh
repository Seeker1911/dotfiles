...
homeFiles="bashrc bash_profile vim vimrc viminfo tmux.conf tags global_gitignore gitconfig Xresources ideavimrc"    # list of files/folders to symlink in homedir
